 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: nTECSInfo_tFuncTypeInfo.c 2665 2017-07-24 08:59:28Z okuma-top $
 */
...
#include <string.h>
#include "nTECSInfo_tFuncTypeInfo_tecsgen.h"
 ...
 * global_name:  nTECSInfo_tFuncTypeInfo_eTypeInfo_getName
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
ER
 ...
 * global_name:  nTECSInfo_tFuncTypeInfo_eTypeInfo_getNameLength
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint16_t
 ...
 * global_name:  nTECSInfo_tFuncTypeInfo_eTypeInfo_getSize
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint32_t
 ...
 * global_name:  nTECSInfo_tFuncTypeInfo_eTypeInfo_getKind
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
int8_t
eTypeInfo_getKind(CELLIDX idx)
{
	...
	/* ここに処理本体を記述します #_TEFB_# */
  return TECSTypeKind_FuncType;
}

/* #[<ENTRY_FUNC>]# eTypeInfo_getNType
 * name:         eTypeInfo_getNType
 * global_name:  nTECSInfo_tFuncTypeInfo_eTypeInfo_getNType
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint32_t
 ...
 * global_name:  nTECSInfo_tFuncTypeInfo_eTypeInfo_getTypeInfo
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
ER
 ...
 * global_name:  nTECSInfo_tFuncTypeInfo_eTypeInfo_getNMember
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint32_t
 ...
 * global_name:  nTECSInfo_tFuncTypeInfo_eTypeInfo_getMemberInfo
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
ER
