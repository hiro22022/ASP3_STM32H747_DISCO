...
#{nest_str}      cMessageBuffer0 = #{@end_region.get_namespace_path}::#{@clientChannelCell}Body0.eMessageBuffer;
...
#{nest_str}      cMessageBuffer0 = #{@start_region.get_namespace_path}::#{@clientChannelCell}Body1.eMessageBuffer;
